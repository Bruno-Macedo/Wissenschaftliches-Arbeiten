...
\begin{itemize}
  \item Interview mit einer Firma, die \acrfull{cba} erstellt
...
Die Sicherheit eines Bezahlsystems steht im Mittelpunkt jeder Firma, die \acrfull{cba} entwickeln. 
Für diese Recherche wollen wir Interviews mit IT-Sicherheitsfirmen führen. Dazu haben wir zwei in Deutschland sitzende Firmen rausgesucht, 
die diese Art von Geschäft schon anbieten: ``REWE digital'' und ``myenso''. In diesem Fall arbeiten wir mit Firmen, 
die zwar einen ähnlichen Dienst anbieten, aber verschiedene Einsätze haben. Während die erste Firma ein großes Unternehmen
ist und mehr als 300.000 Mitarbeiter hat \cite{refst:REWE}, ist die zweite Firma ein kleines und neues Unternehmen, das weniger
...
in verschiedenen Bereichen der Digitalisierung entwickelt, wie Liefer- und Abholservice, sowie Mobile Awnedungen. ``myenso'' 
will ein neues Konzept vom Einkauf anbieten, indem die Kunden mehr Entscheidungen selber treffen können. Im Vergleich 
zu größeren Ketten will ``myenso'' Kunden in Orten erreichen, wo es weniger Einkaufsmöglichkeiten gibt
oder die kein Interesse an großen Ketten haben.
...
und Mechanismen beschäftigen, die die Firmen verwendet, um die Sicherheit ihres Zahlungsverfahrens zu gewährleisten. 
...
sollen in dieser Umfrage gedeckt sein. Für die qualitative Datenerhebung werden Methoden von Fokusgruppe\footnote{Fokusgrupp
...
Befragten die Möglichkeite anbieten \cite{refbook:EFAF}, sich über die existierenden Schwachstellen des angebotenen Dienstes zu äußern 
und auch über verwendete oder in Naher Zukunft verwendete Sicherheitsmaßnahmen.
