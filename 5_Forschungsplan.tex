...
die zwar einen ähnlichen Dienst anbieten, aber verschiedene Einsätze haben. Während die erste ein großes Unternehmen
ist und mehr als 300.000 Mitarbeiter hat \cite{refst:REWE}, ist die zweite ein kleines und neues Unternehmen, das weniger
...
in verschiedenen Bereichen der Digitalisierung entwickelt, wie Liefer- und Abholservice, sowie Mobile Awnedungen. 
...
Befragten die Möglichkeite anbieten \cite{refbook:EFAF}, sich über die existierenden Schwachstellen des angebotenen
...
Videos oder Bilder \cite{refbook:SWIS}.} an die zwei \textit{Zombie} und diese schicken sehr viele kleine Pakete in sehr
kürzem Abstand an das Server, um dessen Kapazität auszulasten, sodass er auf keine Anfragen mehr antworten kann 
