...
\begin{itemize}
    ...
    \item ständige Kontrolle gegen Social Engineering \footnote{Beim Social-Engineering nutzt der Täter den 
    ``Faktor Mensch'' als vermeintlich schwächstes Glied der Sicherheitskette aus, um seine kriminelle
...
einen Mikroprozessor und minimale Funktionalitäten besitzt. Im folgenden ist ein Beispiel von einer Smartcard 
zu sehen: 
