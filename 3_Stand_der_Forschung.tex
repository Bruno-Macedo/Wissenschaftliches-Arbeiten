...
\textbf{Variante 1}  ---> hier gehen wir nochmal auf die Forschungsfrage ein
\textcolor{blue}{Immer wenn mit Karte bezahlt wird, gehen die Kunden davon aus, dass die
Zahlungsabwicklung sicher ist. Wie kann es aber sichergestellt werden, dass bargeldlose Bezahlung 
heutzutage sicher ist?}


\textbf{Variante 2}  ---> ich finde das passt besser zum Stand der Forschung
...
die Akzeptanz von den Nutzenden zu bekommen \cite{refart:HARE}. \par
...
muss die Technologie stets weiterentwickelt und angepasst werden, um Vertraulichkeitverlust von seitens der Kunden zu 
vermeiden. Dieser Mangel an Vertraulichkt ist laut das größte Hindernis, warum viele Kunden sich 
...
Viele digitale Zahlungen finden über WLAN stattf, das kann ein großes Risiko darstellen \cite{refip:NYRS}, 
da WLAN-Verbindungen unsicherer sind, als normale Kabelverbindungen. Maßnahmen zu entwickeln, die sich an 
