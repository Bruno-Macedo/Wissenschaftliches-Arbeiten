...
%\textbf{Vllt noch eine Quelle hier oben.}
...
%\vfill
%\begin{figure}[H]
%    \centering{\includegraphics[width=4cm]{Bilder/refart_JTAS_1.png}}
%    \caption{Muster für den Payment Gateway Centric Scenario\cite{refart:JTAS}}
%    \label{fig:refart:JTAS}
%\end{figure}
%\vfill

%Im folgenden Sequenzdiagramm 

%Definition: Ein Sequenzdiagramm (englisch sequence diagram) ist ein Verhaltensdiagramm,
%welches eine Interaktion im Sinne der Unified Modeling Language (UML) grafisch darstellt.
%https://de.wikipedia.org/wiki/Sequenzdiagramm

%\textbf{Hier auch auch ein Fussnote, der beschreibt, was ein Sequenzdiagramm ist.}
%wird der Nachrichtenflussaustausch zwischen den Mitgliedern bei der Ausführung des PCSM Zahlungsmethode dargestellt:
...
%\vfill
%\begin{figure}[H]
%    \centering{\includegraphics[width=7cm]{Bilder/refart_JTAS_2.png}}
