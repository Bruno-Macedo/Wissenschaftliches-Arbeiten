...
Die Sicherheit in dem \acrfull{tcpip}\footnote{Die \acrshort{tcpip}Protokollfamilie bezieht sich auf die Aufteilung 
...
Laut einer Statistik des \acrfull{ehi} von 2019 \cite{refart:KSDL} bezahlen 48,6\% 
...
\acrfull{pin} bestätigt werden müssen, nimmt immer weiter zu. Doch gerade bei dieser Variante ist es sehr einfach
